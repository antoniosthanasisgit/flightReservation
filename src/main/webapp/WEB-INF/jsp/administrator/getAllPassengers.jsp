...
<h2 class="text-secondary text-center">All passengers</h2>
...
<td scope="row">${passenger.firstName}</td>
<td scope="row">${passenger.lastName}</td>
<td scope="row">${passenger.middleName}</td>
<td scope="row">${passenger.email}</td>
<td scope="row">${passenger.phone}</td>
